...
from plot_util import StateColor
...
class PlotModels():
    ...
    def __init__(self, n_row, n_col, figno=10, **argvs):
        ...
        size_x = argvs.get('size_x', 5)
        size_y = argvs.get('size_y', 3)
        self.figsize = (self.n_col * size_x, self.n_row * size_y)
    ...
    def plot_states_indv(self, pos, cat, pltx=None, pws=None, **args):
        ...
        if pws is not None:
            ...
            self.ax.plot(pltx, plt_pws.T, color='black', lw=0.1)
        # --- decos
